      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-10 pt-6 mt-6 shadow-lg border border-white py-6 pl-3 rounded-md'>
        ...
        <div className="col-span-2 bg-white">
          <div className="profile ml-12">
            ...
            <div className="text">
              <h2 className='font-semibold text-xl text-blue-900 mx-8 pt-3 w-56 flex-col ml-3'>Kartikey Srivastava</h2>
              <p className='font-normal'>Trainee Software Developer</p>
            </div>
          </div>
        </div>
          ...
          <div className="div pt-8">
            <div className="div1  flex space-x-5 pl-10 p-7">
              <div className='emp w-56 flex-col '>
                ...
                <h2 className='text-blue-900 font-semibold '>9085497</h2>
              </div>
              <div className="">
                <h3 className='font-normal ml-4 '>Contact No.</h3>
                <h2 className='text-blue-900 font-semibold ml-4 '>9890972198</h2>
              </div>
            </div>
            <div className="div2 flex space-x-5 pl-10 p-7 pb-10 ">
              <div className='dept flex w-56 flex-col'>
                ...
                <p className='font-semibold overflow-hidden text-blue-900'>Software solutions & Delivery</p>
              </div>
              <div className="reporting">
                <h3 className='font-normal ml-4'>Reporting To</h3>
                <h2 className='  text-blue-900 font-semibold ml-4'>Mathimaran.P</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="div pt-8">
            <div className="div1 flex space-x-5 pl-10 p-7">
              <div className='emp flex w-56 flex-col'>
                ...
                <h2 className='text-blue-900 font-semibold '>kumar_srivastav@cms.co.in</h2>
              </div>
              <div className="contact">
                <h3 className='font-normal '>Location</h3>
                <h2 className='text-blue-900 font-semibold '>Bangalore, India</h2>
              </div>
            </div>
            <div className="div2  flex space-x-52 pl-10 p-7 pb-10">
              <div className='dept flex w-56 flex-col'>
                <h3 className='font-normal'>Employment Status</h3>
                <h2 className='t text-green-500 font-semibold'>Confirmed</h2>
              </div>
            </div>
          </div>
        </div>
